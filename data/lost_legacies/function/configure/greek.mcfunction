...
tag @s add ll_greek
data merge entity @s {CustomName:'Spartan Hoplite',CustomNameVisible:1b}
data merge entity @s {PersistenceRequired:1b}
data merge entity @s {DeathLootTable:"lost_legacies:entities/greek_boss"}
data merge entity @s {drop_chances:{head:0f,chest:0f,legs:0f,feet:0f,mainhand:0f,offhand:0f}}
item replace entity @s weapon.mainhand with minecraft:iron_sword[minecraft:item_model="lost_legacies:greek_xiphos",minecraft:item_name={text:"Xiphos"},minecraft:lore=[{text:"A short blade drawn only when the spear line breaks.",color:"gray"}],minecraft:rarity="epic",minecraft:enchantable={value:18},minecraft:max_damage=400,minecraft:attribute_modifiers=[{type:"attack_damage",id:"lost_legacies:greek_xiphos_damage",amount:9.0,operation:"add_value",slot:"mainhand"},{type:"attack_speed",id:"lost_legacies:greek_xiphos_speed",amount:-2.1,operation:"add_value",slot:"mainhand"}]]
...
attribute @s minecraft:movement_speed modifier add lost_legacies:speed_boost_slow_mob 0.3 add_multiplied_base
