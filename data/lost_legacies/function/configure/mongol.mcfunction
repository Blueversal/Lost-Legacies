...
tag @s add ll_mongol
data merge entity @s {CustomName:'Mongol Warrior',CustomNameVisible:1b}
data merge entity @s {PersistenceRequired:1b}
data merge entity @s {DeathLootTable:"lost_legacies:entities/mongol_boss"}
data merge entity @s {drop_chances:{head:0f,chest:0f,legs:0f,feet:0f,mainhand:0f,offhand:0f}}
item replace entity @s weapon.mainhand with minecraft:iron_sword[minecraft:item_model="lost_legacies:mongol_mongol_saber",minecraft:item_name={text:"Mongol Saber"},minecraft:lore=[{text:"Carried across a horse lord's empire, from steppe to sea.",color:"gray"}],minecraft:rarity="epic",minecraft:enchantable={value:18},minecraft:max_damage=380,minecraft:attribute_modifiers=[{type:"attack_damage",id:"lost_legacies:mongol_mongol_saber_damage",amount:9.0,operation:"add_value",slot:"mainhand"},{type:"attack_speed",id:"lost_legacies:mongol_mongol_saber_speed",amount:-2.1,operation:"add_value",slot:"mainhand"}]]
