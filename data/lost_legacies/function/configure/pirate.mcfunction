...
tag @s add ll_pirate
data merge entity @s {CustomName:'Ghost Captain',CustomNameVisible:1b}
data merge entity @s {PersistenceRequired:1b}
data merge entity @s {DeathLootTable:"lost_legacies:entities/pirate_boss"}
data merge entity @s {drop_chances:{head:0f,chest:0f,legs:0f,feet:0f,mainhand:0f,offhand:0f}}
data merge entity @s {VillagerData:{profession:"minecraft:butcher",type:"minecraft:swamp",level:5}}
item replace entity @s weapon.mainhand with minecraft:iron_sword[minecraft:item_model="lost_legacies:pirate_cutlass",minecraft:item_name={text:"Cutlass"},minecraft:lore=[{text:"Salt crusted steel from a ship that never made port.",color:"gray"}],minecraft:rarity="epic",minecraft:enchantable={value:18},minecraft:max_damage=380,minecraft:attribute_modifiers=[{type:"attack_damage",id:"lost_legacies:pirate_cutlass_damage",amount:9.0,operation:"add_value",slot:"mainhand"},{type:"attack_speed",id:"lost_legacies:pirate_cutlass_speed",amount:-2.3,operation:"add_value",slot:"mainhand"}]]
