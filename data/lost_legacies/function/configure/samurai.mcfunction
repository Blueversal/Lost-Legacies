...
tag @s add ll_samurai
data merge entity @s {CustomName:'Ronin',CustomNameVisible:1b}
data merge entity @s {PersistenceRequired:1b}
data merge entity @s {DeathLootTable:"lost_legacies:entities/samurai_boss"}
data merge entity @s {drop_chances:{head:0f,chest:0f,legs:0f,feet:0f,mainhand:0f,offhand:0f}}
data merge entity @s {VillagerData:{profession:"minecraft:weaponsmith",type:"minecraft:plains",level:5}}
item replace entity @s weapon.mainhand with minecraft:iron_sword[minecraft:item_model="lost_legacies:samurai_katana",minecraft:item_name={text:"Katana"},minecraft:lore=[{text:"A masterless blade, still sharp after centuries.",color:"gray"}],minecraft:rarity="epic",minecraft:enchantable={value:18},minecraft:max_damage=340,minecraft:attribute_modifiers=[{type:"attack_damage",id:"lost_legacies:samurai_katana_damage",amount:10.0,operation:"add_value",slot:"mainhand"},{type:"attack_speed",id:"lost_legacies:samurai_katana_speed",amount:-1.9,operation:"add_value",slot:"mainhand"}]]
