...
tag @s add ll_viking
data merge entity @s {CustomName:'Viking Raider',CustomNameVisible:1b}
data merge entity @s {PersistenceRequired:1b}
data merge entity @s {DeathLootTable:"lost_legacies:entities/viking_boss"}
data merge entity @s {drop_chances:{head:0f,chest:0f,legs:0f,feet:0f,mainhand:0f,offhand:0f}}
item replace entity @s weapon.mainhand with minecraft:iron_axe[minecraft:item_model="lost_legacies:viking_bearded_axe",minecraft:item_name={text:"Bearded Axe"},minecraft:lore=[{text:"Carried across northern seas by a raider who never returned home.",color:"gray"}],minecraft:rarity="epic",minecraft:enchantable={value:18},minecraft:max_damage=500,minecraft:attribute_modifiers=[{type:"attack_damage",id:"lost_legacies:viking_bearded_axe_damage",amount:12.0,operation:"add_value",slot:"mainhand"},{type:"attack_speed",id:"lost_legacies:viking_bearded_axe_speed",amount:-3.0,operation:"add_value",slot:"mainhand"}]]
