...
tag @s add ll_imperial_china
data merge entity @s {CustomName:'Terracotta Sentinel',CustomNameVisible:1b}
data merge entity @s {PersistenceRequired:1b}
data merge entity @s {DeathLootTable:"lost_legacies:entities/imperial_china_boss"}
data merge entity @s {drop_chances:{head:0f,chest:0f,legs:0f,feet:0f,mainhand:0f,offhand:0f}}
data merge entity @s {VillagerData:{profession:"minecraft:librarian",type:"minecraft:jungle",level:5}}
item replace entity @s weapon.mainhand with minecraft:iron_spear[minecraft:item_model="lost_legacies:imperial_china_guandao",minecraft:item_name={text:"Guandao"},minecraft:lore=[{text:"Carried by a sentinel that has stood guard for centuries.",color:"gray"}],minecraft:rarity="epic",minecraft:enchantable={value:18},minecraft:max_damage=300,minecraft:attribute_modifiers=[{type:"attack_damage",id:"lost_legacies:imperial_china_guandao_damage",amount:9.0,operation:"add_value",slot:"mainhand"},{type:"attack_speed",id:"lost_legacies:imperial_china_guandao_speed",amount:-2.8,operation:"add_value",slot:"mainhand"}]]
