...
tag @s add ll_mali
data merge entity @s {CustomName:'Mali Guardian',CustomNameVisible:1b}
data merge entity @s {PersistenceRequired:1b}
data merge entity @s {DeathLootTable:"lost_legacies:entities/mali_boss"}
data merge entity @s {drop_chances:{head:0f,chest:0f,legs:0f,feet:0f,mainhand:0f,offhand:0f}}
item replace entity @s weapon.mainhand with minecraft:iron_spear[minecraft:item_model="lost_legacies:mali_trade_spear",minecraft:item_name={text:"Trade Spear"},minecraft:lore=[{text:"Carried down trade roads by an empire built on salt and gold.",color:"gray"}],minecraft:rarity="epic",minecraft:enchantable={value:18},minecraft:max_damage=300,minecraft:attribute_modifiers=[{type:"attack_damage",id:"lost_legacies:mali_trade_spear_damage",amount:10.0,operation:"add_value",slot:"mainhand"},{type:"attack_speed",id:"lost_legacies:mali_trade_spear_speed",amount:-2.8,operation:"add_value",slot:"mainhand"}]]
