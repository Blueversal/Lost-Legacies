...
data merge entity @s {CustomName:'Cossack Sentinel',CustomNameVisible:1b}
data merge entity @s {PersistenceRequired:1b}
data merge entity @s {DeathLootTable:"lost_legacies:entities/russian_boss"}
data merge entity @s {drop_chances:{head:0f,chest:0f,legs:0f,feet:0f,mainhand:0f,offhand:0f}}
item replace entity @s weapon.mainhand with minecraft:iron_axe[minecraft:item_model="lost_legacies:russian_berdysh",minecraft:item_name={text:"Berdysh"},minecraft:lore=[{text:"Steel that has not seen daylight since the empire fell.",color:"gray"}],minecraft:rarity="epic",minecraft:enchantable={value:18},minecraft:max_damage=480,minecraft:attribute_modifiers=[{type:"attack_damage",id:"lost_legacies:russian_berdysh_damage",amount:11.0,operation:"add_value",slot:"mainhand"},{type:"attack_speed",id:"lost_legacies:russian_berdysh_speed",amount:-2.9,operation:"add_value",slot:"mainhand"}]]
